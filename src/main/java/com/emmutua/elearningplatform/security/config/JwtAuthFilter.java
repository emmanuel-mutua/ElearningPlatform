...
/**
 * Should be active for every request : Check if there is JWT
 * Check if user exists
 * Can add header to the response using OncePerRequestFilter
 */
@Component
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        boolean userEmailNull = userEmail != null;
        if (userEmailNull && userNotAuthenticated){
